...
module.exports.renderSource = async (req, res) => {
    const recordHandler = new RecordHandler(req, res, recordProps, 'sources/source.ejs')
...
module.exports.renderNewSource = async (req, res) => {
    ...
    const recordHandler = new RecordHandler(req, res, recordProps, 'sources/newSource.ejs')
    recordHandler.renderPage(data, recordProps.staticFields)
}

//controller for the post route for submitting a New Source to be approved.
module.exports.submitNewSource = async (req, res) => {
    const recordHandler = new RecordHandler(req, res, recordProps)
...
module.exports.renderReviewSource = async (req, res) => {
    ...
    const recordHandler = new RecordHandler(req, res, recordProps, 'sources/publishSource.ejs')
    const reviewData = await recordHandler.dataLookup('review')
    ...
    recordHandler.renderPage(reviewData, recordProps.staticFields)
}
...
module.exports.publishReviewSource = async (req, res) => {
    const recordHandler = new RecordHandler(req, res, recordProps, '/sources/')
...
module.exports.renderUpdateReviewSource = async (req, res) => {
    const recordHandler = new RecordHandler(req, res, recordProps, 'sources/updateReviewSource.ejs')
    const reviewData = await recordHandler.dataLookup('review')
    if (recordHandler.checkApprovalState(reviewData)) return
    recordHandler.renderPage(reviewData, recordProps.staticFields)
}
...
module.exports.renderEditSource = async (req, res) => {
    const recordHandler = new RecordHandler(req, res, recordProps, 'sources/updatePublicSource.ejs')
    const publicData = await recordHandler.dataLookup('public')
    recordHandler.renderPage(publicData, recordProps.staticFields)
}
