...
const populateFormInfo = (formProperties) => {
    ...
    switch (formProperties.formClass) {
        ...
        break;
        case 'eventForm':
            formProperties.schema = _schemas__WEBPACK_IMPORTED_MODULE_1__.eventSchema
            switch (formProperties.formId) {
                case 'newEvent':
                    formProperties.existingSource = false
                    formProperties.duplicateCheck = 'submitNew'
...
;(0,_utils_autocomplete_js__WEBPACK_IMPORTED_MODULE_11__.autocompleteListener)('PublicEvent')
